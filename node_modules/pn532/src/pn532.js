...
class PN532 extends EventEmitter {
    ...
    */
    ...
    ScanTagWithEvent(){
        ...
        .then((tag_info)=>{
            this.emit('tag', tag_info);
        })
        .catch((err)=>{
            this.emit('tag_err', err);
        })
    }
    DestroyScanTagEvent(){
        this.removeListener('tag',()=>{console.log('removed tag event')});
        this.removeListener('tag_err',()=>{console.log('removed tag_err event')});
    }
